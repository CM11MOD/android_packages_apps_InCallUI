...
public class CallCardPresenter extends Presenter<CallCardPresenter.CallCardUi>
    ...
    private void updatePrimaryDisplayInfo(ContactCacheEntry entry, boolean isConference) {
        ...
        if (entry != null) {
            ...
            ui.setPrimary(number, name, nameIsNumber, entry.label,
                    ...
                    isForwarded, isVideo, entry.nickName, entry.organization, entry.position, entry.city);
        } else {
            ui.setPrimary(null, null, false, null, null, isConference, isGenericConf, false,
                    isForwarded, isVideo, null, null, null, null);
        }
    ...
    public interface CallCardUi extends Ui {
        ...
        void setPrimary(String number, String name, boolean nameIsNumber, String label,
                Drawable photo, boolean isConference, boolean isGeneric, boolean isSipCall, boolean isForwarded,
                boolean isVideo, String nickName, String organization, String position, String city);
